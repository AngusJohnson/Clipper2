...
public class SvgWriter(FillRule fillrule = FillRule.EvenOdd, string coordFontName = "Verdana", int coordFontsize = 9, uint coordFontColor = SvgWriter.black)
{
  ...
  private readonly struct CoordStyle(string fontname, int fontsize, uint fontcolor)
  {
    public readonly string FontName = fontname;
    public readonly int FontSize = fontsize;
    public readonly uint FontColor = fontcolor;
  }

  private readonly struct TextInfo(string text, double x, double y, int fontsize = 12, uint fontcolor = black)
  {
    public readonly string text = text;
    public readonly int fontSize = fontsize;
    public readonly uint fontColor = fontcolor;
    public readonly double posX = x;
    public readonly double posY = y;
  }
  ...
  public FillRule FillRule { get; set; } = fillrule;
  private readonly List<PolyInfo> PolyInfoList = [];
  private readonly List<TextInfo> textInfos = [];
  private readonly CoordStyle coordStyle = new(coordFontName, coordFontsize, coordFontColor);
